...
class MarkdownStyleSheet {
  ...
  factory MarkdownStyleSheet.fromTheme(ThemeData theme) {
    assert(theme.typography.base.fontSize != null);
    return MarkdownStyleSheet(
      a: TextStyle(color: Colors.blue).copyWith(fontSize: 14),
      p: theme.typography.normal.copyWith(fontSize: 14),
      pPadding: EdgeInsets.zero,
      code: theme.typography.normal.copyWith(
        backgroundColor: theme.colorScheme.card,
        fontFamily: 'monospace',
        fontSize: 14,
      ),
      h1: theme.typography.h1.copyWith(fontSize: 20),
      h1Padding: EdgeInsets.zero,
      h2: theme.typography.h2.copyWith(fontSize: 18),
      h2Padding: EdgeInsets.zero,
      h3: theme.typography.h3.copyWith(fontSize: 16),
      h3Padding: EdgeInsets.zero,
      h4: theme.typography.h4.copyWith(fontSize: 14),
      h4Padding: EdgeInsets.zero,
      h5: theme.typography.bold,
      h5Padding: EdgeInsets.zero,
      h6: theme.typography.extraBold,
      h6Padding: EdgeInsets.zero,
      em: const TextStyle(fontStyle: FontStyle.italic),
      strong: const TextStyle(fontWeight: FontWeight.bold),
      del: const TextStyle(decoration: TextDecoration.lineThrough),
      blockquote: theme.typography.base,
      img: theme.typography.base,
      checkbox: theme.typography.base.copyWith(
      ...
      tableBody: theme.typography.base,
  ...
  factory MarkdownStyleSheet.largeFromTheme(ThemeData theme) {
    return MarkdownStyleSheet(
      a: const TextStyle(color: Colors.blue).copyWith(fontSize: 14),
      p: theme.typography.normal,
      pPadding: EdgeInsets.zero,
      code: theme.typography.normal.copyWith(
        backgroundColor: theme.colorScheme.card,
        fontFamily: 'monospace',
